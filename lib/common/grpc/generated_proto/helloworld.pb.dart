...
class RepeatHelloRequest extends $pb.GeneratedMessage {
  ...
  factory RepeatHelloRequest.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory RepeatHelloRequest.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  ...
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
      'Will be removed in next major version')
  RepeatHelloRequest copyWith(void Function(RepeatHelloRequest) updates) =>
      super.copyWith((message) => updates(message as RepeatHelloRequest))
          as RepeatHelloRequest; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static RepeatHelloRequest create() => RepeatHelloRequest._();
  RepeatHelloRequest createEmptyInstance() => create();
  static $pb.PbList<RepeatHelloRequest> createRepeated() =>
      $pb.PbList<RepeatHelloRequest>();
  @$core.pragma('dart2js:noInline')
  static RepeatHelloRequest getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<RepeatHelloRequest>(create);
