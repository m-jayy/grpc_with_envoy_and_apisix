...
class _$UserModelImpl implements _UserModel {
  _$UserModelImpl({required this.id, this.email, this.defaultAddress});
  ...
  @override
  String toString() {
    return 'UserModel(id: $id, email: $email, defaultAddress: $defaultAddress)';
  }
...
abstract class _UserModel implements UserModel {
  factory _UserModel(
      ...
      final String? email,
      final String? defaultAddress}) = _$UserModelImpl;
